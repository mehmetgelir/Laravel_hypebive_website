                ...
                <div class="col-lg-6">
                    <div class="banner_content">
                        ...
                        <div class="d-flex align-items-center">
                            <a id="play-home-video" class="video-play-button" href=/Games>
                                <span></span>
                            </a>
        ...
        <div class="row about_content align-items-center">
            <div class="col-lg-6">
                <div class="section_content">
                    <h6>Rollic CUBE</h6>
                    <h1>Rollic CUBE <br>Heyecan ve Eğlence</h1>
                    <p>Hızlı düşün ve diğer küplere çarpma. Yüksek skorlar elde etmek için küplerin arasından geç!
                    </p>
                    <a class="primary_btn" href="https://play.google.com/store/apps/details?id=com.voodoo.rolliccube">HEMEN OYNA</a>
                </div>
            </div>
            <div class="col-lg-6">
                <video width="800" height="400" loop autoplay muted style="padding-right:500px;">
                    <source src="img/rollic/Gameplay.mp4" type="video/mp4">
                    <source src="img/rollic/Gameplay.ogg" type="video/ogg">
                </video>
                </div>
            </div>
        </div>
        ...
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="img/gamelogo/rolliccubelogo.png" alt="">
                    <div class="upcoming_title">
                        <h3><a href="games.html">Rollic CUBE</a></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="img/gamelogo/catch.png" alt="">
                    <div class="upcoming_title">
                        <h3><a href="/Games">Catch the Suspect</a></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="img/gamelogo/logo.png" alt="">
                    <div class="upcoming_title">
                        <h3><a href="/Games">The Employer</a></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="img/gamelogo/logo1.png" alt="">
                    <div class="upcoming_title">
                        <h3><a href="games.html">New Upcoming</a></h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <aside class="f_widget ab_widget">
                    ...
                    <ul>
                        <li><a href="#"></a>Terms and conditions</a></li><a href="#">
                            <li><a href="/Privacy"></a>Privacy Policy
                        </a></li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="copy_right_text">
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is designer <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.linkedin.com/in/mehmet-gelir-8157b01a7/" target="_blank">Mgelir</a>
